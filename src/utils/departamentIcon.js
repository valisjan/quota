...
export function departamentIconPaths(nom) {
  const icons = {
    ...
    fisicaQuimica: [
      'M9.5 3.75h5',
      'M10.75 3.75v5.1l-4.9 8.45a2 2 0 0 0 1.75 3h8.8a2 2 0 0 0 1.75-3l-4.9-8.45v-5.1',
      'M8.35 15.75h7.3',
      'M9.55 18.25h4.9',
      'M7.95 7.25c-1.45.7-2.45 1.75-2.45 2.95 0 2.15 2.95 3.9 6.5 3.9s6.5-1.75 6.5-3.9c0-1.2-1-2.25-2.45-2.95',
    ],
    ciencies: [
