...
export function departamentIconPaths(nom) {
  const icons = {
    ...
    fisicaQuimica: [
      {
        d: 'M7.65 14.7h8.7l1.55 2.7a1.05 1.05 0 0 1-.9 1.6H7a1.05 1.05 0 0 1-.9-1.6l1.55-2.7Z',
        fill: '#86efac',
        stroke: '#16a34a',
        strokeWidth: 1.25,
      },
      ...
      {
        d: 'M10.75 3.75v5.1l-4.9 8.45a2 2 0 0 0 1.75 3h8.8a2 2 0 0 0 1.75-3l-4.9-8.45v-5.1',
        stroke: '#047857',
      },
      {
        d: 'M7.65 14.7h8.7',
